...
const HomeCoverSection = ({ blogs }) => {
    ...
    return (
        <div className="w-full flex items-center justify-center mt-[8px] md:mt-[12px]">
            <article className="group w-full flex flex-col items-start justify-end mx-5 sm:mx-10 relative h-[55vh] sm:h-[60vh] md:h-[65vh] lg:h-[75vh] xl:w-[95vw] xl:h-[80vh] overflow-hidden rounded-3xl">
                ...
                <div className="w-full lg:w-4/6 p-6 sm:p-8 md:p-12  lg:p-16 flex flex-col items-start justify-center z-0 text-white">
                    <Tag
                        ...
                        name={blog.tags[0]}
                        className="dark:text-white dark:border-white text-white border-white"
                    />
